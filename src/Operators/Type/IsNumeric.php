 ...
 * Returns true for integers, floats, and numeric strings like "123" or "45.67",
 * including values in scientific notation. Unlike strict type checks, this accepts
 * both actual numbers and string representations of numbers.
 *
