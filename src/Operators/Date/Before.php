...
/**
 * Evaluates whether one date/time occurs chronologically before another.
 *
...
{
    /**
     * Evaluates whether the left operand date/time is before the right operand date/time.
     *
    ...
    private function convertToCarbon(mixed $value): Carbon
    {
        ...
        throw InvalidDateTimeException::forOperation('Before');
    }
}
