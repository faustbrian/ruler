 ...
 * equivalent to (A ∪ B) - (A ∩ B) in set theory.
 *
...
final class SymmetricDifference extends VariableOperator implements VariableOperand
{
     ...
     *
     * Extracts both set operands from the context and computes their
     * symmetric difference, producing a new set containing elements
     * that exist in exactly one of the two input sets.
     *
     ...
     * @return Value   Returns a Value object containing the symmetric difference set,
     *                 which includes elements unique to either set but not common to both
     */
