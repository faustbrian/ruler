 ...
 *
 * Performs a less-than-or-equal-to comparison between the left and right
 * operands after resolving them within the given context. The implementation
 * uses the inverse of the greaterThan comparison to determine if the left
...
{
    /**
     * Evaluates the less-than-or-equal-to comparison between left and right operands.
     *
     * @param  Context $context Execution context providing variable values for operand resolution
     * @return bool    True if the left operand value is less than or equal to the right operand value
     */
