 ...
 *
 * This operator performs a greater-than comparison between the left and right
 * operands after resolving them within the given context. The comparison is
 * delegated to the Value object's greaterThan method, which implements the
 * specific comparison logic for different value types.
 *
