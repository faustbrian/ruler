...
/**
 * Checks if a value does not exist within an array using strict comparison.
 *
 * Evaluates whether the left operand's value is absent from the right operand's
...
{
    /**
     * Evaluates whether the left operand does not exist in the right operand array.
     *
     ...
     *
     * @return bool True if the value does not exist in the array, false if it is found
     */
    public function evaluate(Context $context): bool
    {
        ...
        throw_unless(is_array($array), RuntimeException::class, 'NotIn: second operand must be an array');
