...
final class Between extends VariableOperator implements Proposition
{
     ...
     * @param VariableOperand $min   Minimum boundary value (inclusive)
     * @param VariableOperand $max   Maximum boundary value (inclusive)
     */
     ...
     *
     * @throws RuntimeException If any operand value is not numeric
     *
    ...
    public function evaluate(Context $context): bool
    {
        ...
        if (!is_numeric($val) || !is_numeric($minVal) || !is_numeric($maxVal)) {
            throw new RuntimeException('Between: all values must be numeric');
        }
     ...
     *
     * @return OperandCardinality Multiple cardinality (requires three operands: value, min, max)
     */
