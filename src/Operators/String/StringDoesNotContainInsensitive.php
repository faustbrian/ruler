...
/**
 * Evaluates whether a string does not contain a substring using case-insensitive comparison.
 *
 * Performs case-insensitive substring matching by checking if the left operand
 * does not contain the right operand anywhere within it. Character case is ignored,
...
{
    /**
     * Evaluates the case-insensitive string non-containment comparison.
     *
     ...
     * @return bool    True if the left operand does not contain the right operand (case-insensitive),
