...
/**
 * Evaluates whether a string starts with a specific prefix.
 *
 * Performs case-sensitive prefix matching to determine if the left operand
 * string begins with the right operand substring. Comparison respects
 * character case.
 *
...
{
    /**
     * Evaluates the case-sensitive starts-with comparison.
     *
