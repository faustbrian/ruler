...
/**
 * Evaluates whether a string contains a substring (case-insensitive).
 *
 * Performs case-insensitive substring matching to determine if the left
 * operand string contains the right operand substring anywhere within it.
 * Character case is ignored during comparison.
 *
...
{
    /**
     * Evaluates the case-insensitive string-contains comparison.
     *
