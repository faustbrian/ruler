...
/**
 * Maximum value extraction operator for collections.
 *
 * Extracts the maximum value from a collection or set. The operand must resolve
 * to a value containing a set, and this operator returns the highest value from
 * that set.
 *
...
{
    /**
     * Prepares the maximum value from the operand's set.
     *
     * @param  Context $context Evaluation context for resolving the operand
     * @return Value   Value object containing the maximum value from the set
     */
