 ...
 *
 * This exception is raised during rule evaluation when the RuleEvaluator encounters
 * malformed rule data, unrecognized logical combinators, or structural inconsistencies
 * that prevent proper proposition evaluation.
 *
