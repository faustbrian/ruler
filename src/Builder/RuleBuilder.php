...
final class RuleBuilder implements ArrayAccess
{
    ...
    /**
     * Create a new Rule with the given condition, explicit id, and optional action.
     *
     ...
     * @param  RuleId       $id        Explicit non-empty rule identifier.
     ...
     */
    public function create(Proposition $condition, RuleId $id, ?Closure $action = null): Rule
    {
        return new Rule(
            $condition,
            $action,
