...
{
    /**
     * Reference to the RuleBuilder instance that created this variable.
     *
     * @var RuleBuilder
     */
    private mixed $ruleBuilder;
     ...
     *
     * @param RuleBuilder $ruleBuilder the RuleBuilder instance that manages this variable
     *                                 and provides access to registered operators
    ...
    {
        return new StringContains($this, self::asVariable($variable));
    }
    ...
    {
        return new StringDoesNotContain($this, self::asVariable($variable));
    }
    ...
    {
        return new StringContainsInsensitive($this, self::asVariable($variable));
    }
    ...
    {
        return new GreaterThan($this, self::asVariable($variable));
    }
    ...
    {
        return new GreaterThanOrEqualTo($this, self::asVariable($variable));
    }
    ...
    {
        return new LessThan($this, self::asVariable($variable));
    }
    ...
    {
        return new LessThanOrEqualTo($this, self::asVariable($variable));
    }
    ...
    {
        return new EqualTo($this, self::asVariable($variable));
    }
    ...
    {
        return new NotEqualTo($this, self::asVariable($variable));
    }
    ...
    {
        return new SameAs($this, self::asVariable($variable));
    }
    ...
    {
        return new NotSameAs($this, self::asVariable($variable));
    }
    ...
    {
        return new ContainsSubset($this, self::asVariable($variable));
    }
    ...
    {
        return new DoesNotContainSubset($this, self::asVariable($variable));
    }
    ...
    {
        return new SetContains($this, self::asVariable($variable));
    }
    ...
    {
        return new SetDoesNotContain($this, self::asVariable($variable));
    }
    ...
    {
        return $this->wrap(
            new Addition($this, self::asVariable($variable)),
        );
    }
    ...
    {
        return $this->wrap(
            new Division($this, self::asVariable($variable)),
        );
    }
    ...
    {
        return $this->wrap(
            new Modulo($this, self::asVariable($variable)),
        );
    }
    ...
    {
        return $this->wrap(
            new Multiplication($this, self::asVariable($variable)),
        );
    }
    ...
    {
        return $this->wrap(
            new Subtraction($this, self::asVariable($variable)),
        );
    }
    ...
    {
        return $this->wrap(
            new Exponentiate($this, self::asVariable($variable)),
        );
    }
    ...
    {
        return new EndsWith($this, self::asVariable($variable));
    }
    ...
    {
        return new EndsWithInsensitive($this, self::asVariable($variable));
    }
    ...
    {
        return new StartsWith($this, self::asVariable($variable));
    }
    ...
    {
        return new StartsWithInsensitive($this, self::asVariable($variable));
    }
     ...
     */
    private static function asVariable($variable): BaseVariable
    {
