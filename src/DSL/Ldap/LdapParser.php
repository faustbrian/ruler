...
final class LdapParser
{
     ...
     *
     * @return LdapNode LogicalNode representing AND operation
     */
     ...
     * @throws RuntimeException If no conditions are provided
     *
     * @return LdapNode LogicalNode representing OR operation
     */
     ...
     *
     * @return LdapNode LogicalNode representing NOT operation
     */
