...
final readonly class GraphQLFilterRuleBuilder
{
    ...
    /** @var RuleBuilder builder that wraps propositions in executable Rule objects */
     ...
     *
     * @param null|RuleBuilder $ruleBuilder Optional custom rule builder instance. When null,
