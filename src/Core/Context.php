...
final class Context implements ArrayAccess
{
     ...
     *
     * @codeCoverageIgnore PHP attribute - method body is tested
     */
    public function offsetGet(mixed $name): mixed
    {
        ...
        if (array_key_exists($name, $this->frozen) || !is_object($value) || $this->protected->offsetExists($value) || !$this->isCallable($value)) {
            return $value;
        }
