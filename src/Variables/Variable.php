...
{
    /**
     * The variable name used for context lookups.
     *
     * @var null|string
     */
    private mixed $name;
    ...
    /**
     * The default value used when the variable name is not found in the context.
     */
    private mixed $value;
     ...
     *                           resolve from its default value.
     * @param mixed       $value The default value used when the variable name is not
     *                           found in the context, or when name is null. Can be
     *                           a scalar, array, object, or VariableOperand.
     */
