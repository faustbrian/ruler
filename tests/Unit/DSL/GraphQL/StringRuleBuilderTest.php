...
test('parse simple comparison expression', function (): void {
    ...
    $rule = $gql->parse(['age' => ['gt' => 18]], RuleIds::fromString('test-rule'));
...
test('parse equality operator', function (): void {
    $gql = new GraphQLFilterRuleBuilder();
    $rule = $gql->parse(['status' => ['eq' => 'active']], RuleIds::fromString('test-rule'));
...
test('parse implicit equality', function (): void {
    $gql = new GraphQLFilterRuleBuilder();
    $rule = $gql->parse(['status' => 'active'], RuleIds::fromString('test-rule'));
...
test('parse not expression', function (): void {
    $gql = new GraphQLFilterRuleBuilder();
    $rule = $gql->parse(['NOT' => ['age' => ['lt' => 18]]], RuleIds::fromString('test-rule'));
...
test('parse in operator with array', function (): void {
    $gql = new GraphQLFilterRuleBuilder();
    $rule = $gql->parse(['country' => ['in' => ['US', 'CA', 'UK']]], RuleIds::fromString('test-rule'));
...
test('parse matches operator with regex', function (): void {
    $gql = new GraphQLFilterRuleBuilder();
    $rule = $gql->parse(['phone' => ['match' => '^\\d{3}-\\d{4}$']], RuleIds::fromString('test-rule'));
...
test('parse less than or equal operator', function (): void {
    $gql = new GraphQLFilterRuleBuilder();
    $rule = $gql->parse(['age' => ['lte' => 65]], RuleIds::fromString('test-rule'));
...
test('parse inequality operator', function (): void {
    $gql = new GraphQLFilterRuleBuilder();
    $rule = $gql->parse(['status' => ['ne' => 'inactive']], RuleIds::fromString('test-rule'));
...
test('parse notIn operator', function (): void {
    $gql = new GraphQLFilterRuleBuilder();
    $rule = $gql->parse(['role' => ['notIn' => ['banned', 'suspended']]], RuleIds::fromString('test-rule'));
...
test('parse contains operator', function (): void {
    $gql = new GraphQLFilterRuleBuilder();
    $rule = $gql->parse(['email' => ['contains' => '@example.com']], RuleIds::fromString('test-rule'));
...
test('parse startsWith operator', function (): void {
    $gql = new GraphQLFilterRuleBuilder();
    $rule = $gql->parse(['name' => ['startsWith' => 'John']], RuleIds::fromString('test-rule'));
...
test('parse endsWith operator', function (): void {
    $gql = new GraphQLFilterRuleBuilder();
    $rule = $gql->parse(['filename' => ['endsWith' => '.pdf']], RuleIds::fromString('test-rule'));
...
test('parse range query with multiple operators', function (): void {
    $gql = new GraphQLFilterRuleBuilder();
    $rule = $gql->parse(['age' => ['gte' => 18, 'lte' => 65]], RuleIds::fromString('test-rule'));
