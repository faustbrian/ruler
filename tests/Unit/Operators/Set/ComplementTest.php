...
describe('Complement', function (): void {
    describe('Happy Paths', function (): void {
        ...
        test('complement', function ($a, $b, $result): void {
    ...
    describe('Sad Paths', function (): void {
        test('invalid data', function (): void {
            ...
            $op = new Complement($varA, $varB);
            expect($op->prepareValue($context)->getValue())->toEqual(['string']);
        });
    });
});

dataset('complementData', fn (): array => [
    [6, 2, [6]],
    [
        ['a', 'b', 'c'],
        'a',
