...
describe('Context', function (): void {
    describe('Happy Paths', function (): void {
        ...
        test('returns raw closure definition', function (): void {
            $context = new Context();
            $context['fact'] = $definition = function () {
                return 'foo';
            };
 ...
 */
dataset('badFactDefinitionProvider', function () {
    return [
        [123],
        [new Fact()],
    ];
 ...
 */
dataset('factDefinitionProvider', function () {
    return [
        ['closure'],
        ['invokable'],
    ];
...
function resolve_fact_definition(string $definition): callable
{
    return match ($definition) {
        'closure' => static function (Context $context): Fact {
            return new Fact($context);
        },
