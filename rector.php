...
return RectorConfig::configure()
    ...
    ->withSkip([
        ...
        NewInInitializerRector::class => [
            __DIR__.'/src/DSL/Natural/NaturalLanguageRuleBuilder.php',
            __DIR__.'/src/DSL/MongoDB/MongoQueryRuleBuilder.php',
            __DIR__.'/src/DSL/GraphQL/GraphQLFilterRuleBuilder.php',
        ],
    ])
